...
clf=DecisionTreeClassifier(random_state=1,min_samples_split=2)
clf.fit(train[columns],train["high_income"])
test_auc1=roc_auc_score(test["high_income"],clf.predict(test[columns]))
